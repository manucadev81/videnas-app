...
|---|---|---|---|
| **Responsável de Compliance** (`diretor`) | Cliente | Aprova o que a Videnas já validou e registra a transmissão ao órgão, em nome da instituição. Não escolhe tenant, não configura o que é da Videnas | Não |
