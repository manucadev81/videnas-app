...
interface SimboloSentinellusProps {
  className?: string;
}

export function SimboloSentinellus({ className }: SimboloSentinellusProps) {
  return (
    <svg
      viewBox="0 0 80 80"
      ...
      role="img"
      aria-label="Símbolo Sentinellus"
    >
...
interface LogoSentinellusProps {
  className?: string;
}

export function LogoSentinellus({ className }: LogoSentinellusProps) {
  return (
    <svg
      viewBox="0 0 240 60"
      xmlns="http://www.w3.org/2000/svg"
